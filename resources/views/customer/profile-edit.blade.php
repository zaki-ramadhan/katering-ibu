        ...
        <div class="content-wrapper grid grid-cols-3 gap-7">
            ...
            <form method="POST" action="{{ route('profile.update', auth()->user()->id) }}" enctype="multipart/form-data" class="flex flex-col gap-3">
                ...
                <label for="foto_profile" class="form-label text-sm text-primary font-medium relative group">
                    ...
                    <label for="foto_profile" class="hidden font-normal px-4 py-2 rounded-md text-white border border-white absolute top-1/2 left-1/2 -translate-x-1/2 text-sm -translate-y-1/2 z-20 group-hover:inline-block hover:bg-black/20 active:scale-95 duration-100 cursor-pointer">Unggah gambar</label>
                </label>
