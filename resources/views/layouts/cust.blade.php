...
<body
    class="font-inter bg-slate-50 sm:bg-tertiary {{ Route::currentRouteName() == 'profile.edit' ? 'lg:bg-tertiary' : 'lg:bg-white' }} min-h-screen">
    ...
    <!-- Page Content -->
    <main
        class="container {{ Route::currentRouteName() == 'profile.edit' ? 'w-[78%] pb-20' : '' }} {{Route::currentRouteName() == 'customer.keranjang' || Route::currentRouteName() == 'customer.order-history' || Route::currentRouteName() == 'customer.dashboard' ? 'pb-20' : ''}} ">
        @yield('content')
    </main>
