                ...
                <div class="text-input-group absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center gap-6 lg:gap-8">
                    ...
                    <div class="input-wrapper w-max relative flex items-center justify-center">
                        <form action="">
                            ...
                            <input type="search" name="search-menu" id="search-menu" placeholder="Cari menu favoritmu disini..." autocomplete="off" required class="w-72 lg:w-[30rem] truncate rounded-md text-sm py-3 ps-12 pe-9 text-primary focus:outline-none focus:ring-0 border-0 focus:border-transparent">
