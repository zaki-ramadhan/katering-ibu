...
<html lang="en">
    ...
    <body class="font-inter bg-red-500 sm:bg-white">
        ...
        {{-- header --}}
        <header class="container px-4 py-5 flex justify-between items-center font-semibold">
        ...
        <main class="main-content-wrapper container px-4 py-6 lg:px-8">
                ...
                <section id="detail-menu-section" class="mt-4 p-4 lg:col-span-2 rounded-xl bg-white text-primary">
                    <figure class="w-full flex lg:flex-row gap-6">
                        ...
                        <figcaption class="flex-auto flex flex-col gap-1">
                            ...
                            text-white rounded-md py-3 text-xs md:text-sm mb-3">Detail menu</p>
