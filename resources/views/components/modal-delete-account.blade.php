<div class="overlay-modal-delete-account hidden w-full h-full bg-black/70 backdrop-blur-sm place-content-center absolute top-1/2 left-1/2 -translate-x-[25%] -translate-y-[25%] z-50">
